...
import { createProductBadgePreset } from "@/services/admin-catalog/badge-preset-crud";
...
export async function POST(request: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    const badgePreset = await createProductBadgePreset(validationResult.data);
    ...
    const message = error instanceof Error ? error.message : "Failed to create badge preset.";
