...
import { applyProductBulkAction } from "@/services/admin-catalog/product-crud";
...
export async function POST(request: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    const result = await applyProductBulkAction(
    ...
    console.error("Admin product bulk POST error:", {
    ...
    const message = error instanceof Error ? error.message : "Failed to apply the bulk product action.";
