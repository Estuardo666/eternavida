...
export function paymentStatusUpdateTemplate(
  ...
  const contentHtml = `
    <h2 style="margin:0 0 8px;font-size:22px;font-weight:700;color:#2D2D2D;">Actualización de pago</h2>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:24px;">
      <tr>
        ...
        <td style="padding:10px 0;border-bottom:1px solid #D9D2C5;font-size:14px;color:#6B6B6B;text-align:right;">${PAYMENT_STATUS_LABELS[oldStatus]}</td>
      </tr>
      <tr>
