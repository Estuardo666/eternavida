...
export function orderStatusUpdateTemplate(
  ...
  const contentHtml = `
    <h2 style="margin:0 0 8px;font-size:22px;font-weight:700;color:#1a1a1a;">Actualización de tu pedido</h2>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:24px;">
      <tr>
        ...
        <td style="padding:10px 0;border-bottom:1px solid #e8f0e5;font-size:14px;color:#4a4a4a;text-align:right;">${STATUS_LABELS[oldStatus]}</td>
      </tr>
      <tr>
